...
global.reloadHandler = async function (restatConn) {
  ...
  conn.spromote = '🎉 *Felicidades @user ahora eres admin del grupo!!* 🎉'
  conn.sdemote = '*Lástima @user, ya no eres administrador!!* 😿'
  conn.sDesc = '*La nueva descripción del grupo es:*\n\n@desc'
  conn.sSubject = '*El nuevo nombre del grupo es:*\n\n@subject'
  conn.sIcon = '*La foto del grupo ha cambiado!!* 🌟'
  conn.sRevoke = '*Ahora este es el nuevo link del grupo!!*\n\n*@revoke*'
