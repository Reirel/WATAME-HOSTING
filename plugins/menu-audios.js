...
['𝗠𝗲𝗻𝘂́ 𝗖𝗼𝗺𝗽𝗹𝗲𝘁𝗼 💫', '.allmenu'],
['𝗠𝗲𝗻𝘂́ 𝗗𝗲𝘀𝗽𝗹𝗲𝗴𝗮𝗯𝗹𝗲 🌟', '/menulista'],
['𝗠𝗲𝗻𝘂́ 𝗣𝗿𝗶𝗻𝗰𝗶𝗽𝗮𝗹 ⚡', '#menu']
], m)  
...
const sections = [
{
title: `𝗟𝗜𝗦𝗧𝗔 𝗗𝗘 𝗔𝗨𝗗𝗜𝗢𝗦`,
rows: [
{title: "❇️ 𝗠𝗲𝗻𝘂 𝗣𝗿𝗶𝗻𝗰𝗶𝗽𝗮𝗹 ❇️", description: null, rowId: `${usedPrefix}menu`},
{title: "✳️ 𝗠𝗲𝗻𝘂 𝗖𝗼𝗺𝗽𝗹𝗲𝘁𝗼 ✳️", description: null, rowId: `${usedPrefix}allmenu`},
{title: "✅ 𝗖𝘂𝗲𝗻𝘁𝗮𝘀 𝗢𝗳𝗶𝗰𝗶𝗮𝗹𝗲𝘀 ✅", description: null, rowId: `${usedPrefix}cuentasgatabot`},  
