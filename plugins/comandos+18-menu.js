...
let pict =['https://files.catbox.moe/3x95jo.jpg',
'https://files.catbox.moe/l4dqrk.jpg',
'https://files.catbox.moe/qpfsek.jpg',
'https://files.catbox.moe/bdeyhs.jpg',
'https://files.catbox.moe/18ji2y.jpg']
...
╭━━━━〔 *MENÚ +18* 〕━━━━⬣
┃🔞➺ _${usedPrefix}nintendo_
┃🔞➺ _${usedPrefix}cosplay_
┃🔞➺ _${usedPrefix}toloveru_
┃🔞➺ _${usedPrefix}konosuba_
┃🔞➺ _${usedPrefix}rezero_
┃🔞➺ _${usedPrefix}nsfwnaruto_
┃🔞➺ _${usedPrefix}dragonmaid_
┃🔞➺ _${usedPrefix}heroacademy_
┃🔞➺ _${usedPrefix}dbz_
┃🔞➺ _${usedPrefix}kitagawa_
┃🔞➺ _${usedPrefix}genshin_
┃🔞➺ _${usedPrefix}hololive_
┃🔞➺ _${usedPrefix}kimetsu_
┃🔞➺ _${usedPrefix}tatsumaki_
┃🔞➺ _${usedPrefix}pokemon_
┃🔞➺ _${usedPrefix}uzaki_
┃🔞➺ _${usedPrefix}darling_
