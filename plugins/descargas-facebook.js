...
conn.reply(m.chat, `*Por favor espera...✨*`, fkontak, m)
...
conn.sendMessage(m.chat, { video: { url }, caption: res?.meta?.title || `*Aquí tienes🐬💕*` }, { quoted: m })
} catch (e) {
m.reply(`${fg}*Algo salió mal, recuerda que el video no pude ser de una cuenta privada!*`)
}}
handler.command = /^((facebook|fb)(downloder|dl)?)$/i
export default handler
