        ...
        for (let name in global.plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                    this.reply(m.chat, `${ag}𝗡𝗢 𝗧𝗜𝗘𝗡𝗘𝗦 𝗗𝗜𝗔𝗠𝗔𝗡𝗧𝗘𝗦. 💎 𝗣𝗨𝗘𝗗𝗘𝗦 𝗖𝗢𝗠𝗣𝗥𝗔𝗥 𝗗𝗜𝗔𝗠𝗔𝗡𝗧𝗘𝗦 𝗖𝗢𝗡 𝗘𝗟 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 *${usedPrefix}buy* _cantidad_`, m)
                    continue // Limit habis
                }
                if (plugin.level > _user.level) {
                    this.reply(m.chat, `𝗡𝗘𝗖𝗘𝗦𝗜𝗧𝗔𝗦 𝗘𝗟 𝗡𝗜𝗩𝗘𝗟 ➡️ *${plugin.level}* 𝗣𝗔𝗥𝗔 𝗣𝗢𝗗𝗘𝗥 𝗨𝗦𝗔𝗥 𝗘𝗦𝗧𝗘 𝗖𝗢𝗠𝗔𝗡𝗗𝗢. 𝗧𝗨 𝗡𝗜𝗩𝗘𝗟 𝗘𝗦 ➡️ *${_user.level}* 𝗔𝗖𝗧𝗨𝗔𝗟𝗜𝗭𝗔 𝗧𝗨 𝗡𝗜𝗩𝗘𝗟 𝗖𝗢𝗡 𝗘𝗟 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 *${usedPrefix}nivel*`, m)
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡¡Este comando solo lo puede usar mí Creador!!*',
        owner: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡¡Este comando solo puede ser utilizado por mí creador!!*',
        mods: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡¡Este comando solo puede ser utilizado por administradores!!*',
        premium: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡¡Este comando es solo para miembros premium y mí creador(a)!!',
        group: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡¡Este comando solo se puede usar en grupos!!*',
        private: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡¡Este comando solo se puede usar en mi chat privado!!*',
        admin: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡¡Este comando es solo para administradores!!*',
        botAdmin: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡¡Debo ser admin para poder usar este comando!!*',
        unreg: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡Qué esperas para estar verificando(a)! Usa el comando #verificar*',
        restrict: '╰⊱⚠️⊱ *ADVERTENCIA* ⊱⚠️⊱╮\n\n*¡¡Esta función está restringida por mí creador!!*'
    }[type]
